...
class MonteCarloSimulation(object):
    ...
    def __init__(self, n_simulations=1, dataset_size=10000, save_to_file=False, random_seed=1976):
    ...
    def sim_additive_model(self):
        ...
        data_df = pd.DataFrame(data[0], columns=['Z', 'T', 'Y'])
